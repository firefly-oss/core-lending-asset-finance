...
public interface AssetFinanceAgreementMapper {
    AssetFinanceAgreementDTO toDTO(AssetFinanceAgreement entity);
    AssetFinanceAgreement toEntity(AssetFinanceAgreementDTO dto);
}
